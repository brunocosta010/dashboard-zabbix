...
<body>
  <header class="kiosk-header">
    <div class="brand"><span class="brand-mark"><img id="companyLogo" src="<?= $logo ?>" alt=""></span><div><strong id="companyName"><?= $company ?></strong><span>Central de operações</span></div></div>
    ...
    <div class="header-summary" aria-label="Resumo operacional">
      ...
      <span><i class="dot down"></i><b id="downServices">—</b> indisponíveis</span>
      <span><i class="dot unknown"></i><b id="unknownServices">—</b> sem dados</span>
      <span><i class="dot problem"></i><b id="problemCount">—</b> alertas</span>
    </div>
    <div class="sync"><span>Atualizado</span><b id="updatedAt">--:--:--</b><small id="refreshCountdown">próximo em --s</small><i class="sync-track"><em id="progress"></em></i></div>
  </header>

  <main class="dashboard-grid" id="kioskGrid">
    <section class="dashboard-widget widget-cpu"><div class="widget-content panel">
    ...
    <section class="dashboard-widget widget-memory"><div class="widget-content panel">
    ...
    <section class="dashboard-widget widget-services"><div class="widget-content panel services-panel">
    ...
    <section class="dashboard-widget widget-latency"><div class="widget-content panel">
    ...
    <section class="dashboard-widget widget-time"><div class="widget-content panel time-panel">
      <span id="date">--/--/----</span><strong id="clock">--:--</strong><small id="weekday">---</small>
    </div></section>

    <section class="dashboard-widget widget-health"><div class="widget-content panel health-panel" id="healthPanel">
      <i></i><div><strong id="overallState">ANALISANDO</strong><span id="overallDetail">Aguardando dados</span></div>
    </div></section>

    <section class="dashboard-widget widget-updates"><div class="widget-content panel updates-panel">
    ...
    <section class="dashboard-widget widget-problems"><div class="widget-content panel problems-panel">
